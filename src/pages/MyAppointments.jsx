            ...
            <div className="flex flex-col gap-2 justify-end">
              ...
              {!item.cancelled && (
                <button
                  ...
                  className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-[#f60909] hover:text-white transition-all duration-300 cursor-pointer"
                >
                  Cancel appointment
                </button>
              )}
